...
const Members = () => {
    return (
        <div id='work' className='flex mt-10 h-screen  flex-col items-center gap-4  text-gray-800' >
            ...
            <div className="flex gap-4 sm:justify-center  w-full overflow-scroll ">

                {serviceData.map(({ icon, title, description }, index) => (

                    <div className='flex flex-col items-center cursor-pointer text-xs rounded flex-shrink-0 ' key={index} >
